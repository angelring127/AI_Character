...
SPEAKER_REFERENCE = [
    "/workspace/wavs/output-0001.wav",
    "/workspace/wavs/output-0050.wav"# speaker reference to be used in training test sentences
]
...
def main():
    ...
    print(eval_samples)
    assert len(eval_samples) > 0, "평가 데이터셋이 비어 있습니다."
